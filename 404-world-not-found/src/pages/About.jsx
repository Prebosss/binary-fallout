...
export default function About() {
  return (
    <div className="relative min-h-screen min-w-screen overflow-hidden font-theme">
      ...
      <div className="relative z-10 min-h-screen flex flex-col backdrop-blur-sm">
        <Navbar />
        <main className="flex-1 flex flex-col items-center justify-center p-4 text-green-400 text-shadow-lg pt-20">
          <h1 className="text-[4.5rem] font-bold mb-12">ERROR 404: EARTH NOT FOUND</h1>
          <p className="text-lg font-extrabold max-w-5xl text-center">
